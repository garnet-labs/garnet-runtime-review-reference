<!-- Vendored from garnet-labs/posthog tools/pr-approval-agent @ e72c8c344344 (2026-08-25) — the engine running in the PostHog lanes, unmodified except --repo defaults. -->
# PR approval agent
